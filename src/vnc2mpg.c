...
#define VNC_PIX_FMT       AV_PIX_FMT_RGBA //AV_PIX_FMT_RGB565  /* pixel format generated by VNC client */
           ...
           int *bps)
{
    ...
    client = rfbGetClient(8,3,4); //8,3,4 // bitsPerSample, samplesPerPixel, bytesPerPixel
    client->format.redShift=0; client->format.redMax=255;
    client->format.greenShift=8; client->format.greenMax=255;
    client->format.blueShift=16; client->format.blueMax=255;
